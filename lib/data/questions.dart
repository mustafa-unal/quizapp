import 'package:quizzapp/models/questions_model.dart';
...
const questions = [
  ...
  Question(
    question:
        "Flutter'da, widget'ların boyutunu ve yerini ayarlamak için hangi widget kullanılır?",
  ...
  Question(
    question:
        "Flutter'da bir ekran arasında geçiş yapmak için hangi sınıf kullanılır?",
    answers: ["Navigator", "Router", "ScreenManager", "PageTransition"],
    correctAnswer: "Navigator",
  ),
  Question(
    question:
        "Flutter'da widgetler arası veri iletişimi için hangi yöntem kullanılabilir?",
    answers: ["Callback fonksiyonları", "Event bus", "Provider paketi", "Tümü"],
    correctAnswer: "Provider paketi",
  ),
  Question(
    question:
        "Flutter'da, bir ekranın üst kısmına sabit bir app bar eklemek için hangi widget kullanılır?",
