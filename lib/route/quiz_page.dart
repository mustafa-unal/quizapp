...
class _QuizAppState extends State<QuizApp> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          AppColor.backgroundColor(Color.fromRGBO(76, 125, 123, 1)),
      appBar: AppBar(
        ...
        backgroundColor:
            AppColor.backgroundColor(const Color.fromRGBO(76, 125, 123, 1)),
        centerTitle: true,
      ),
      body: Center(
        child: Column(
                  ...
                  child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          ...
                          backgroundColor: AppColor.buttonBackgroundColor(
                              const Color.fromRGBO(248, 198, 96, 1))),
                      child: Text(answer)),
                );
              }).toList(),
            ),
